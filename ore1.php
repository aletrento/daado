<?php
session_start();
unset($_SESSION["calendario"], $_SESSION["ora_ini"], $_SESSION["min_ini"], $_SESSION["ora_fine"], $_SESSION["min_fine"], $_SESSION["descrizione"], $_SESSION["categoria"], $_SESSION["tipo"]);
?>
<!DOCTYPE html>
<html>
<head>
...
<form action="ore2.php?pg=1" method="POST" style="font-family: 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;" class="forms">
...
<td>
<input type="text" id="datepicker" name="calendario" placeholder="ad es. 2015-09-30" value="<?php echo $calendario; ?>" />
</td>
 </tr>
</table>
