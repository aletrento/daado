...
<br>
 ...
 <h3 align="center">Modifica dati&nbsp;&nbsp;&nbsp;&nbsp;
  <img src="img/update.gif" width="29" height="20" title="modifica" align="center">
 </h3>

<br><br>

<div align="right">
Torna alla <a href="tabella.php">tabella</a> di riepilogo.
</div>

<br><br>

<div align="left" class="tools-alert tools-alert-blue">
Qui puoi modificare i dati che hai precedentemente inserito.<br>
<u>NB</u>: Se devi modificare i campi '<b>categoria</b>', '<b>tipo</b>' e '<b>tag</b>', utilizza i valori riportati nella legenda che segue.
</div>
...
$strSQL = "SELECT * FROM eventi WHERE utente = '".$_SESSION["username"]."' AND id = '".$_GET["id"]."' ";
...
<form action="salvafor.php?id=<?=$_GET["id"];?>" name="editfor" method="POST" class="forms">
...
<form action="salva.php?id=<?=$_GET["id"];?>" name="edit" method="POST" class="forms">
<div class="table-container" align="center">
 <table class="table-hovered">
  <tr>
   <th class="text-left highlight">giorno</th>
   <th class="text-left highlight">mese</th>
   <th class="text-left highlight">anno</th>
  </tr>
  <tr>
...
<div class="table-container" align="center">
 <table class="table-hovered">
  <tr>
   <th class="text-left highlight">inizio (ora)</th>
   <th class="text-left highlight">inizio (minuti)</th>
   <th class="text-left highlight">fine (ora)</th>
   <th class="text-left highlight">fine (minuti)</th>
  </tr>
  <tr>
...
<div class="table-container" align="center">
 <table class="table-hovered">
  <tr>   
   <th class="text-left highlight">attività</th>
  </tr>
  <tr>
   <td><input type="text" class="width-40" name="descrizione" maxlength="60" value="<?=$objResult["descrizione"];?>"></td>
  </tr>
 </table>
</div>   
<div class="table-container" align="center">
 <table class="table-hovered">
  <tr>   
   ...
   <th class="text-left highlight">tipo</th>
   <th class="text-left highlight">tag</th>
  </tr>
  <tr>
   <td><input type="text" name="categoria" maxlength="8" value="<?=$objResult["categoria"];?>"></td>
   <td><input type="text" name="tipo" maxlength="2" value="<?=$objResult["tipo"];?>"></td>
...
<div align="center">
<input type="submit" name="submit" value="AGGIORNA" class="btn btn-blue btn-outline width-40" />
</div>
</form>
