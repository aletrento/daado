...
$tag=$_POST["tag"];
if (!$tag){
echo '<div class="tools-alert tools-alert-red">'."Errore:".'<br>'."Impossibile salvare i tuoi dati perché non hai scelto un tag per l'attività svolta.".'<br>'."Per favore torna indietro e completa.".'</div><br><br><center><a href="ore6.php?pg=6"><img src="img/arrow_indietro.png" width="80" height="40" title="indietro"></a></center>';
}
else{
