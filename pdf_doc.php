...
{
echo $risultato["titolo"]." ".$risultato["nome"]." ".$risultato["cognome"].'<br>'."scuola: ".$risultato["scuola"].'<br>'."disciplina: ".$risultato["materia"].'<br>'."a.s.: ".$risultato["anno"].'<br>';
}
?>
questo file è stato creato dalla segreteria (<?php echo $_SESSION['username'];?>) il giorno: <?php echo (date("d-m-y"));?>
<div class="units-row">
<div class="unit-centered unit-95">
<br>
<h4 align="center">Riepilogo delle attività svolte da <?php echo $risultato["nome"];?> <?php echo $risultato["cognome"];?></h4>
<br>
<?
...
<div class="tools-alert smaller" align="right">
...
$mpdf->Output('tabella_docente_'.$utente.'_'.$giorno.'.pdf','I');
exit;
}
?>