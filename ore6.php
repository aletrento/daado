...
<body>
<?php
if((isset($_POST['tipo']) && trim($_POST['tipo'])!="") && $_GET['pg']==5){
 ...
 $errore1='<br><br><br><br><div class="tools-alert tools-alert-red">'."Errore.".'<br>'."E' impossibile procedere perché non hai specificato se l'attività è frontale o non frontale.".'</div>';
}
}
if($errore1!=""){
 echo "$errore1";
?>
<center>
<a href="ore5.php?pg=6"><img src="img/arrow_indietro.png" width="80" height="40" title="indietro"></a>
</center>
<?php
}
else{
