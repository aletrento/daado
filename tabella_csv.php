...
{
$path = "./csv/";
$out_file = $path.'tabella_'.$_SESSION['username'].'_'.date("d-m-Y-h:i").'.csv';
$write_file = fopen($out_file,"w") or die("Qualcosa non funziona... non riesco ad aprire il file.");

fputcsv($write_file, array('UTENTE', 'GIORNO', 'MESE', 'ANNO', 'ORA_INIZIO', 'MIN_INIZIO', 'ORA_FINE', 'MIN_FINE', 'FORFAIT', 'COSA_HAI_FATTO', 'CATEGORIA', 'TIPO', 'TAG'));
$link = mysql_connect('', '', '');
