...
<html>
<head>
<title>conferma eliminazione evento</title>
...
<div class="unit-centered unit-80">
 ...
 <div>
  <h2><p align="center">Conferma eliminazione evento forfetario</p></h2><img src="img/bin.png" width="19" height="20" title="cancella" align="middle">
 </div>
...
if($result)
{
echo '<div class="tools-alert tools-alert-green">'."L'evento è stato eliminato.".'</div>';
}
else {
