...
$n_utenti = mysql_query("SELECT * FROM utenti WHERE username NOT LIKE 'seg_%' AND username!='admin' AND username!='sudo'");
$utenti = (mysql_num_rows($n_utenti));
...
$array_scuole = array();
$query = "SELECT * FROM utenti WHERE nome!='' AND cognome!=''";
...
<h3 align="center"><img src="img/pie.png" style="vertical-align:middle" width="45" height="45" alt="numeri">&nbsp;&nbsp;&nbsp;&nbsp;<font color="#BF803F">Informazioni sugli utenti registrati</font></h3>
...
Qui si può vedere, mese per mese, il totale orario delle <font color="#6977EE"><i>attività funzionali</i></font> e di quelle caricate su <font color="#6977EE"><i>art. 2</i></font>, <font color="#6977EE"><i>art. 3</i></font> e <font color="#6977EE"><i>FUIS</i></font>. Quelle di tipo forfetario non sono prese in considerazione in questo grafico.<br>
<center>
<figure><img src="grafico_10.php" /></figure>
</center>
In questo grafico si vede il numero delle attività salvate per ciascuna <font color="#6977EE"><i>fascia oraria</i></font> escluse le attività forfetarie.<br>
<center>
<figure><img src="grafico_11.php" /></figure>
</center>
</div>
...
<img src="img/stats.png" align="middle" width="40" height="40" title="frequenze" alt="frequenze"/>
&nbsp;&nbsp;&nbsp;&nbsp;Vuoi sapere quali sono le <a href="frequenze.php">parole chiave</a> che ricorrono più frequentemente nella descrizione delle attività svolte?
</div>
