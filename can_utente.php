...
<div class="unit-centered unit-80">
 ...
 <div>
  <h2><p align="center">Conferma eliminazione utente</p></h2><img src="img/bin.png" width="19" height="20" title="cancella" align="middle">
 </div>
...
if($result)
{
echo '<div class="tools-alert tools-alert-green">'."L'utente è stato eliminato dal database.".'</div>';
}
else {
	echo '<div class="tools-alert tools-alert-red">'."Errore: impossibile eliminare l'utente selezionato.".'</div>';
}
mysql_close();
?>
