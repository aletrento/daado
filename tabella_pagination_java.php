...
$('#att').after('<div id="nav"></div>');
var rowsShown = 15;
var rowsTotal = $('#att tbody tr').length;
...
$('#att tbody tr').hide();
$('#att tbody tr').slice(0, rowsShown).show();
...
$('#att tbody tr').css('opacity','0.0').hide().slice(startItem, endItem).
...
<table class="table-hovered sortable" id="att">
 <thead>
  <tr>
