...
<body>
<?php
if((isset($_POST['calendario']) && trim($_POST['calendario'])!="") && $_GET['pg']==1){
 ...
 $errore1='<br><br><br><br><div class="tools-alert tools-alert-red">'."Errore.".'<br>'."E' impossibile procedere perché non hai inserito una data.".'</div>';
}
}
if($errore1!=""){
 echo "$errore1";
?>
<center>
<a href="ore1.php?pg=2"><img src="img/arrow_indietro.png" width="80" height="40" title="indietro"></a>
</center>
<?php
}
else{
// echo "inserita data ".$_SESSION['calendario']."<br>";
// echo "prosegui<br>";
 if(isset($_SESSION['ora_ini'])){
 $ora_ini=$_SESSION['ora_ini'];
}
else{
 $ora_ini="";
}
if(isset($_SESSION['min_ini'])){
 $min_ini=$_SESSION['min_ini'];
}
else{
 $min_ini="";
}
if(isset($_SESSION['ora_fine'])){
 $ora_fine=$_SESSION['ora_fine'];
}
else{
 $ora_fine="";
}
if(isset($_SESSION['min_fine'])){
 $min_fine=$_SESSION['min_fine'];
}
else{
 $min_fine="";
}
...
<br><br>
<form action="ore3.php?pg=2" method="POST" style="font-family: 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;" class="forms">
   ...
   <table class="table-simple">
    <tbody>
     <tr>
      ...
      <td>ora: <input type="text" name="ora_ini" maxlength="2" placeholder="ad es. 14" value="<?php echo $ora_ini; ?>" /></td>
      <td>minuti: <input type="text" name="min_ini" maxlength="2" placeholder="ad es. 20" value="<?php echo $min_ini; ?>" /></td>
     </tr>
     <tr>
      <td>fine attività</td>
      <td>ora: <input type="text" name="ora_fine" maxlength="2" placeholder="ad es. 16" value="<?php echo $ora_fine; ?>" /></td>
      <td>minuti: <input type="text" name="min_fine" maxlength="2" placeholder="ad es. 35" value="<?php echo $min_fine; ?>" /></td>
     </tr>
    </tbody>
   </table>
 </div>
